...
Title.Text = "Adicionar Música ao GitHub"
...
NameBox.PlaceholderText = "Ex: Minha Música Custom"
NameBox.Text = ""
...
UploadButton.MouseButton1Click:Connect(function()
    ...
    if uploadSongToGitHub then
        ...
        UploadButton.Text = "Função não encontrada!"
        UploadButton.BackgroundColor3 = Color3.fromRGB(200, 50, 50)
    end
end)
